# CyberCLI: Terms of Service and Privacy Notice

CyberCLI is an open-source tool that lets you interact with Google's powerful language models directly from your command-line interface. The Terms of Service and Privacy Notices that apply to your usage of the CyberCLI depend on the type of account you use to authenticate with Google.

This article outlines the specific terms and privacy policies applicable for different account types and authentication methods. Note: See [quotas and pricing](./quota-and-pricing.md) for the quota and pricing details that apply to your usage of the CyberCLI.

## How to determine your authentication method

Your authentication method refers to the method you use to log into and access the CyberCLI. There are four ways to authenticate:
...
- **Terms of Service:** Your use of the CyberCLI is governed by the [Google Terms of Service](https://policies.google.com/terms?hl=en-US).
...
- **Terms of Service:** Your use of the CyberCLI is governed by the [Google Cloud Platform Terms of Service](https://cloud.google.com/terms).
...
- **Terms of Service:** Your use of the CyberCLI is governed by the [Gemini API Terms of Service](https://ai.google.dev/gemini-api/terms). These terms may differ depending on whether you are using an unpaid or paid service:
...
- **Terms of Service:** Your use of the CyberCLI is governed by the [Google Cloud Platform Service Terms](https://cloud.google.com/terms/service-terms/).
...
## Frequently Asked Questions (FAQ) for the CyberCLI
...
The **Usage Statistics** setting is the single control for all optional data collection in the CyberCLI.
