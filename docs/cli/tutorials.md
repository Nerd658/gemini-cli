...
This page contains tutorials for interacting with CyberCLI.
...
CyberCLI uses this value in the `mcpServers` configuration that you defined in the `settings.json` file.

#### Launch CyberCLI and verify the connection

When you launch CyberCLI, it automatically reads your configuration and launches the GitHub MCP server in the background. You can then use natural language prompts to ask CyberCLI to perform GitHub actions. For example:
