# CyberCLI file system tools

The CyberCLI provides a comprehensive suite of tools for interacting with the local file system. These tools allow the Gemini model to read from, write to, list, search, and modify files and directories, all under your control and typically with confirmation for sensitive operations.
...
These file system tools provide a foundation for the CyberCLI to understand and interact with your local project context.
